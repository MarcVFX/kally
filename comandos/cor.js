...
module.exports.run = async (client, message, args) =>{
   ...
   if(message.guild.id !== "420316735149965322") return message.channel.send(`:question: **|** ${message.author} comando inexistente, para saber todos meus comandos digite **k!ajuda**`).then(msg => msg.delete(5000));
   ...
   const emojicor1 = client.guilds.get("418902107391918080").emojis.find("name", "emojiCor1");
   const emojicor2 = client.guilds.get("418902107391918080").emojis.find("name", "emojiCor2");
   const emojicor3 = client.guilds.get("418902107391918080").emojis.find("name", "emojiCor3");
   const emojicor4 = client.guilds.get("418902107391918080").emojis.find("name", "emojiCor4");
   let role1 = message.guild.roles.find("id", "453629192748138527");
   let role2 = message.guild.roles.find("id", "453629825920532480");
   let role3 = message.guild.roles.find("id", "458718075693432834");
